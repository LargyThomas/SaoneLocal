...
const user1 = {usersEmail:process.env.SEED_PRODUCER1_EMAIL, usersPassword:process.env.SEED_PRODUCER1_PASSWORD, usersGender:"M", usersLastName:"Durand", usersFirstName:"Michel", usersCreationDate:"19/05/2026", usersLastConnexion:"19/05/2026 11:00", usersRole:2, usersStatus:"active"}
...
const user2 = {usersEmail:process.env.SEED_PRODUCER2_EMAIL, usersPassword:process.env.SEED_PRODUCER2_PASSWORD, usersGender:"F", usersLastName:"Fontaine-Marchais", usersFirstName:"Isabelle", usersCreationDate:"19/05/2026", usersLastConnexion:"19/05/2026 11:00", usersRole:2, usersStatus:"active"}
const producer2 = {producerId:2, producerDesc:"Bonjour je m'appelle Isabelle Fontaine-Marchais, je suis vigneronne au Domaine de la Côte Chalonnaise, Mercurey. Productrice de vins de Bourgogne depuis 1987.", producerLocalisation:"Mercurey, Saône-et-Loire, 71640)", producerSiretNum:"58120479361584", producerStatus:"active"}
...
const product1 = {productId:1, producerId:producer1["producerId"], categoryId:category1["categoryId"], subcategoryId:subcategory1["subcategoryId"], productName:"clos du roi", productPrice:30, productDesc:"Ce vin est un premier cru du domain Chamirey.", productStatus:"active"}
const product2 = {productId:2, producerId:producer1["producerId"], categoryId:category1["categoryId"], subcategoryId:subcategory2["subcategoryId"], productName:"bourgogne", productPrice:15, productDesc:"Vin créer à partir des saveurs régionals.", productStatus:"active"}
const product3 = {productId:3, producerId:producer2["producerId"], categoryId:category2["categoryId"], subcategoryId:subcategory6["subcategoryId"], productName:"baguette au levain", productPrice:1.5, productDesc:"une baguette croustillante au levain", productStatus:"active"}
const product4 = {productId:4, producerId:producer2["producerId"], categoryId:category2["categoryId"], subcategoryId:subcategory6["subcategoryId"], productName:"lot de 3 baguettes au levain", productPrice:4, productDesc: "lot de 3 baguettes croustillante au levain", productStatus:"active"}

module.exports = {admin, association, usersAssociation, user1, producer1, user2, producer2,
